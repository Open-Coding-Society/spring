        ...
        return args -> {
            ...
            for (Assignment assignment : assignmentArray) {
                ...
                if (assignmentFound == null) { // if the assignment doesn't exist
                    ...
                    submissionJPA.save(new AssignmentSubmission(newAssignment, List.of(personJpaRepository.findByUid("madam")), "","test comment", false));
                }
            }
